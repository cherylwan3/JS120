...
function Student(firstName, lastName, age, gender, BA) {
  Person.call(this, firstName, lastName, age, gender);
  this.degree = BA;
}
...
function GraduateStudent(firstName, lastName, age, gender, BA, MS) {
  Student.call(this, firstName, lastName, age, gender, BA);
  this.graduateDegree = MS;
}
...
let professor = new Professor('Jace', 'Lee', 35, 'female', 'computer science');
